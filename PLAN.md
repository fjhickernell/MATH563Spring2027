# MATH 563 Spring 2027 Plan

## Purpose and References

Build a coherent Mathematical Statistics course using the current HickernellAcademicLib course-site family. MATH 563 Spring 2026 supplies the MATH 563 content model; MATH 565 Fall 2026 supplies the more recent infrastructure and teaching workflow model.
...
`~/SoftwareRepositories/MATH563Spring2027` is the canonical public-source repository. The corresponding OneDrive Spring 2027 folder is private and is not a Git repository.
