...
The canonical public checkout is `~/SoftwareRepositories/MATH563Spring2027`; the corresponding OneDrive folder is private.

This is the authoritative source skeleton for MATH 563 Spring 2027. Read `README.md`, `PLAN.md`, `STATUS.md`, `AUTHOR_WORKFLOW.md`, and `notes/NEXT.md` before substantive work; inspect Git status and submodule status.
