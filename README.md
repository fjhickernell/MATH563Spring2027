# MATH 563 — Mathematical Statistics (Spring 2027)
...
- `slides/`: independent RevealJS project with five carried-forward Spring 2026 decks awaiting revision
...
The canonical public-source checkout is `~/SoftwareRepositories/MATH563Spring2027`. The separate OneDrive Spring 2027 course folder is private. Keep private assessments, rosters, grading, and confidential instructor notes outside this public-source Git repository.

## Publication Status

Public repository: [fjhickernell/MATH563Spring2027](https://github.com/fjhickernell/MATH563Spring2027). GitHub Pages is configured to serve the `gh-pages` branch. Course website: [MATH 563 Spring 2027](https://fjhickernell.github.io/MATH563Spring2027/).
